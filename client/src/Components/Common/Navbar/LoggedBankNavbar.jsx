        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex items-center relative" ref={dropdownRef}>
            ...
            >
              ...
              <span className="hidden md:block font-bold text-slate-700 mr-2">Bank Portal</span>
            </button>
            ...
            >
              <div className="px-4 py-3 border-b border-slate-100">
                <p className="text-sm font-bold text-slate-900 tracking-wide truncate">Blood Bank</p>
                <p className="text-xs text-slate-500 truncate mt-0.5">Manage your portal</p>
              </div>
              <div className="py-2">
                <Link
                  to="/bloodBankProfile"
